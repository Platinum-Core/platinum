...
// Copyright (c) 2019-2019 The Platinum developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (93500, uint256("0x83c2156861b24dfc470e64b9ba740fd2af661d6e605f476c1218b33af0187025"))
    (103000, uint256("0xdeb991f522157dcdf11b20ab8ef16140da14b94d7954bfeea59ce86ede735125"));
    
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1569236041, // * UNIX timestamp of last checkpoint block
    227125,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nLastPOWBlock = 200;
	nStakingMinInput = 300 * COIN;
        nMaturity = 40;
        nMasternodeCountDrift = 20;
        nModifierUpdateBlock = 700;
	nRewardUpgradeBlock = 100000;
        ...
        vSeeds.push_back(CDNSSeedData("sed8", "sed8.dashplatinum.org"));
...
CScript CChainParams::GetScriptForDevFeeDestination() {
    CBitcoinAddress DevFeeRewardAddress("Xxt1HCFMyefUki8xdriJjfz76S6U2F5xcR");
