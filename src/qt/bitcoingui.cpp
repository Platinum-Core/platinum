...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PLAT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and platinum: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Platinum Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PLAT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PLAT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PLAT addresses"));
    ...
    openAction->setStatusTip(tr("Open a PLAT: URI or payment request"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Platinum Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PLAT network", "", count));
}
...
{
    QString strTitle = tr("Platinum Core"); // default title
