...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Platinum Core"),
     ...
     * override -datadir in the platinum.conf file in the default data directory
     * (to be consistent with platinumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
