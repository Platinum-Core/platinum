...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::PLAT)
    {
    }
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    // update the display unit, to not use the default ("PLAT")
    updateDisplayUnit();
}
...
void OverviewPage::updateObfuscationProgress()
{
    ...
    if (currentBalance == 0) {
        ...
        strAmountAndRounds = strAnonymizePlatinumAmount + " / " + tr("%n Rounds", "", nObfuscationRounds);
