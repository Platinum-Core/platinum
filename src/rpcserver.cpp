...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Platinum features */
        {"platinum", "masternode", &masternode, true, true, false},
        {"platinum", "listmasternodes", &listmasternodes, true, true, false},
        {"platinum", "getmasternodecount", &getmasternodecount, true, true, false},
        {"platinum", "masternodeconnect", &masternodeconnect, true, true, false},
        {"platinum", "masternodecurrent", &masternodecurrent, true, true, false},
        {"platinum", "masternodedebug", &masternodedebug, true, true, false},
        {"platinum", "startmasternode", &startmasternode, true, true, false},
        {"platinum", "createmasternodekey", &createmasternodekey, true, true, false},
        {"platinum", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"platinum", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"platinum", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"platinum", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"platinum", "getmasternodescores", &getmasternodescores, true, true, false},
        {"platinum", "mnbudget", &mnbudget, true, true, false},
        {"platinum", "preparebudget", &preparebudget, true, true, false},
        {"platinum", "submitbudget", &submitbudget, true, true, false},
        {"platinum", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"platinum", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"platinum", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"platinum", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"platinum", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"platinum", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"platinum", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"platinum", "checkbudgets", &checkbudgets, true, true, false},
        {"platinum", "mnsync", &mnsync, true, true, false},
        {"platinum", "spork", &spork, true, true, false},
        {"platinum", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"platinum", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use platinumd, or the -server option to platinum-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> platinum-cli " + methodname + " " + args + "\n";
}
