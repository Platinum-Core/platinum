...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Platinum Core platinum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  platinum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded platinum transaction") + "\n" +
                               "  platinum-tx [options] -create [commands]   " + _("Create hex-encoded platinum transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded platinum transaction
