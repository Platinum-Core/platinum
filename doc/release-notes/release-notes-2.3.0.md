PLAT Core version 2.3.0 is now available from:

  <https://github.com/platinum-project/platinum/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/platinum-project/platinum/issues>

Compatibility
==============

PLAT Core is extensively tested on multiple operating systems using
...
PLAT Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) PLAT MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode PLAT address
...
PLAT Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for PLAT (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with PLAT (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/platinum-project-translations/).
