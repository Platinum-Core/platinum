...
In order to support loading of multiple wallets in platinum-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is platinum.cpp.
...
Changes to platinum.cpp
----------------------
platinum.cpp is the entry point into platinum-qt, and as such, will require some minor modifications to provide hooks for
